...
{ 
  Serial.begin(9600);
  middle.attach(3);  // attaches the servo on pin 11 to the middle object
  left.attach(5);  // attaches the servo on pin 10 to the left object
  right.attach(6);  // attaches the servo on pin 9 to the right object
